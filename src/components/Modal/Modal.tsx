...
import { CANCEL, EDIT, SAVE } from '@/constants'
import { ModalProps } from './Modal.interface'
import useAuth from '@/hooks/useAuth/useAuth'

export default function Modal({children, open, setOpen, headline, form}:ModalProps) {
    ...
    return (
        ...
        <button
            ...
            className="rounded-md bg-blue-600 h-full px-2.5 py-1.5 text-sm font-semibold text-white inset-ring inset-ring-white/5 hover:bg-blue-600/90 cursor-pointer duration-100"
        >
            {EDIT}
        </button>
